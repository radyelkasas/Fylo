...
const Footer = () => {
  const [contact, setContact] = useState([
    { icon: "icon-phone.svg", text: "+0201010428983" },
    { icon: "icon-email.svg", text: "radyrado00@gmail.com" },
  ]);
      ...
      <section className="bg-[#0c1524] pt-[320px] md:pt-[200px] pb-[100px] text-white">
        <div className="container">
          ...
          <div className="flex justify-between flex-wrap flex-col md:flex-row gap-[30px] mt-[30px]">
            <div className="flex gap-[15px] items-start w-[340px] max-w-full">
              <img
                src="./images/icon-location.svg"
                alt="icon-location"
                className="w-[18px] h-[18px] object-contain"
              />
              <p className="font-normal tex-sm tracking-[0.8px]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Recusandae, corrupti voluptatibus. Eum recusandae praesentium
                sunt perferendis odio. Inventore, quod corporis?
              </p>
            </div>
            <div>
              {contact.map((item) => (
